...
<div class="container d-flex align-items-center justify-content-center" style="min-height: 72vh;">
    ...
    <div class="card shadow border-light rounded-lg">
        <div class="card-body"> 
            ...
            <form method="POST" action="{{ route('video.call.join.post', ['sessionId' => $meetings->session_id]) }}">
                @csrf
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <img src="{{ route('captcha.create') }}" alt="CAPTCHA Image" id="captcha_image" class="me-2" style="height: 50px;">
