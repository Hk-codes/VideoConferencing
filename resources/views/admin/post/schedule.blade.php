    ...
    <div class="row justify-content-center w-100">
        <div class="col-md-8">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('meeting.schedule.post') }}">
                        @csrf
                        ...
                        <div class="d-flex">
                            ...
                            <!-- Back Button -->
                            <button type="button" onclick="window.location='{{ route('post.index') }}'" class="btn bg-secondary text-white btn-lg ">
